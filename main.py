...
if st.button('Predict Probability'):
    ...
    input_df = pd.DataFrame({'batting_team':[batting_team],'bowling_team':[bowling_team],'city':[selected_city], 'runs_left':[runs_left],'balls_left':[balls_left],'wickets':[wickets],'total_runs_x':[target],'crr':[crr],'rrr':[rrr], 'pitch_conditions': [pitch_conditions], 'weather_conditions': [weather_conditions], 'match_context': [match_context]})
